...
module BarclampRaid
  class Lsi_Sasircu < BarclampRaid::Driver
    ...
    def create_vd(controller, volume)
      ...
      max_size       = (Rebar::RAID::TERA * 2 - Rebar::RAID::MEGA) / Rebar::RAID::MEGA
      size           = nil
      curr_boot_mode = nil
      pend_boot_mode = nil
      ...
      if (@nodeinfo["rebar_wall"] and @nodeinfo["rebar_wall"]["track"] and @nodeinfo["rebar_wall"]["track"]["bios_settings"] and @nodeinfo["rebar_wall"]["track"]["bios_settings"]["boot_mode"])
        boot_mode_data = @nodeinfo["rebar_wall"]["track"]["bios_settings"]["boot_mode"]
    ...
    def get_array_size(volume)
      ...
      disk_size  = (volume[:disks][0].size/Rebar::RAID::MEGA - 2048)  if (volume[:disks] and volume[:disks].length > 0)
